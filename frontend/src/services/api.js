...
export const addBulkTransaction = (data) => api.post('/transactions/bulk', data);
...
export const chatWithAI = (session_id, question, language = 'en-US') => api.post('/chat', { session_id, question, language });
export const recognizeProduct = (image) => api.post('/vision/recognize', { image });
export const getProductImage = (name) => api.get(`/inventory/product-image?name=${encodeURIComponent(name)}`);
...
export const getInventoryOptimization = () => api.get('/inventory-optimization');
